...
-- 区域
regions = {
	{ config_id = 7, shape = RegionShape.SPHERE, radius = 5, pos = { x = 342.7, y = -29.0, z = 437.5 } },
	{ config_id = 37, shape = RegionShape.SPHERE, radius = 5, pos = { x = 337.2, y = -29.0, z = 435.3 } }
}
...
function action_EVENT_SELECT_OPTION_37(context, evt)
	...
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240004003, 11, 10) then
		return -1
	end
