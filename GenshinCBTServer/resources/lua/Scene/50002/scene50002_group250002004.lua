...
gadgets = {
	...
	{ config_id = 148, gadget_id = 70210021, pos = { x = 1603.2, y = 272.8, z = -649.3 }, rot = { x = 0.0, y = 243.2, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 149, gadget_id = 70210021, pos = { x = 1563.8, y = 255.0, z = -649.5 }, rot = { x = 0.0, y = 302.7, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 154, gadget_id = 70210021, pos = { x = 1587.0, y = 287.9, z = -807.9 }, rot = { x = 0.0, y = 347.7, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 176, gadget_id = 70510006, pos = { x = 1477.6, y = 285.8, z = -887.6 }, rot = { x = 0.0, y = 40.2, z = 0.0 }, level = 1 },
	{ config_id = 178, gadget_id = 70210021, pos = { x = 1548.4, y = 289.6, z = -891.8 }, rot = { x = 0.0, y = 235.1, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	...
	{ config_id = 201, gadget_id = 70210021, pos = { x = 1299.8, y = 359.2, z = -858.0 }, rot = { x = 0.0, y = 113.6, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 207, gadget_id = 70520012, pos = { x = 1537.5, y = 259.5, z = -693.1 }, rot = { x = 0.0, y = 244.7, z = 0.0 }, level = 1 },
	{ config_id = 212, gadget_id = 70210021, pos = { x = 1633.2, y = 280.1, z = -717.9 }, rot = { x = 0.0, y = 17.7, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	...
	{ config_id = 276, gadget_id = 70210021, pos = { x = 1453.8, y = 260.1, z = -568.3 }, rot = { x = 0.0, y = 210.7, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	...
	{ config_id = 403, gadget_id = 70210021, pos = { x = 1179.3, y = 291.4, z = -988.8 }, rot = { x = 0.0, y = 73.6, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 414, gadget_id = 70210021, pos = { x = 1400.7, y = 247.7, z = -343.5 }, rot = { x = 0.0, y = 134.5, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST }
}
