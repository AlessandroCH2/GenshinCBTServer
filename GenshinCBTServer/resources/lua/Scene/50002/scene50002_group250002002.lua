...
monsters = {
	...
	{ config_id = 99, monster_id = 23040101, pos = { x = 1579.4, y = 286.9, z = -948.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 15, disableWander = true },
...
gadgets = {
	...
	{ config_id = 157, gadget_id = 70210021, pos = { x = 1615.6, y = 289.7, z = -865.0 }, rot = { x = 0.0, y = 134.7, z = 0.0 }, level = 1, chest_drop_id = 201000, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
