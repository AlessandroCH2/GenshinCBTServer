...
-- 怪物
monsters = {
	{ config_id = 524, monster_id = 20011001, pos = { x = 2227.3, y = 273.7, z = -1672.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 12 },
	{ config_id = 525, monster_id = 20010801, pos = { x = 2224.9, y = 274.2, z = -1660.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 12 }
}
