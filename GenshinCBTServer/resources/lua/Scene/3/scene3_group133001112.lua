...
-- 怪物
monsters = {
	{ config_id = 544, monster_id = 20020101, pos = { x = 1331.8, y = 303.4, z = -1867.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 10, drop_id = 200601, isOneoff = true }
}
...
regions = {
	...
	{ config_id = 216, shape = RegionShape.SPHERE, radius = 5, pos = { x = 1333.6, y = 302.7, z = -1867.1 } }
}
