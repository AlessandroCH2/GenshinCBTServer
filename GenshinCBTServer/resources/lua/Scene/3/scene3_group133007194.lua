...
-- 装置
gadgets = {
	{ config_id = 700, gadget_id = 70900039, pos = { x = 2478.3, y = 245.7, z = 466.3 }, rot = { x = 0.0, y = 3.6, z = 0.0 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 226, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2478.2, y = 245.7, z = 466.3 } }
}
