...
-- 怪物
monsters = {
	{ config_id = 291, monster_id = 28030101, pos = { x = 1752.6, y = 265.2, z = -692.6 }, rot = { x = 0.0, y = 48.7, z = 0.0 }, level = 0, pose_id = 901 },
	{ config_id = 292, monster_id = 28030101, pos = { x = 1761.9, y = 266.3, z = -685.2 }, rot = { x = 0.0, y = 48.7, z = 0.0 }, level = 0, pose_id = 901 },
	{ config_id = 293, monster_id = 28030101, pos = { x = 1750.8, y = 263.0, z = -686.3 }, rot = { x = 0.0, y = 48.7, z = 0.0 }, level = 0, pose_id = 901 },
	{ config_id = 294, monster_id = 28030101, pos = { x = 1759.1, y = 265.5, z = -691.5 }, rot = { x = 0.0, y = 25.2, z = 0.0 }, level = 0, pose_id = 901 }
}
