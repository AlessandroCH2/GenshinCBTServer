...
-- 装置
gadgets = {
	{ config_id = 377, gadget_id = 70900007, pos = { x = 2813.4, y = 207.5, z = 369.4 }, rot = { x = 0.0, y = 36.2, z = 0.0 }, level = 1, persistent = true }
}

-- 区域
regions = {
	{ config_id = 50, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2812.6, y = 207.7, z = 371.0 } }
}
