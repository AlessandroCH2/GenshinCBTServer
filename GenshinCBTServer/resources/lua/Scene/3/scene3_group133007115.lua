...
-- 怪物
monsters = {
	{ config_id = 187, monster_id = 20011001, pos = { x = 2119.2, y = 211.6, z = -31.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005, disableWander = true },
	{ config_id = 188, monster_id = 20011001, pos = { x = 2112.7, y = 210.6, z = -36.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005, disableWander = true }
}
...
-- 装置
gadgets = {
	{ config_id = 411, gadget_id = 70500000, pos = { x = 2117.5, y = 211.3, z = -35.0 }, rot = { x = 0.0, y = 213.8, z = 0.0 }, level = 1, point_type = 3007 },
	{ config_id = 412, gadget_id = 70500000, pos = { x = 2115.9, y = 211.5, z = -32.0 }, rot = { x = 0.0, y = 79.9, z = 0.0 }, level = 1, point_type = 3007 },
	{ config_id = 413, gadget_id = 70500000, pos = { x = 2113.3, y = 210.9, z = -34.8 }, rot = { x = 0.0, y = 246.4, z = 0.0 }, level = 1, point_type = 3007 },
	{ config_id = 637, gadget_id = 70210021, pos = { x = 2115.5, y = 211.3, z = -34.0 }, rot = { x = 0.0, y = 285.8, z = 0.0 }, level = 1, chest_drop_id = 403325, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 58, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2115.7, y = 210.2, z = -32.4 } },
	{ config_id = 144, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2115.3, y = 211.4, z = -33.5 } }
}
