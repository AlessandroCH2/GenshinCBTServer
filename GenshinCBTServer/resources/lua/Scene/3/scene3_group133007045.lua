...
-- 怪物
monsters = {
	{ config_id = 86, monster_id = 20011301, pos = { x = 2670.7, y = 211.9, z = 377.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 }
}
...
-- 装置
gadgets = {
	{ config_id = 175, gadget_id = 70210022, pos = { x = 2670.9, y = 212.8, z = 381.8 }, rot = { x = 0.0, y = 161.5, z = 0.0 }, level = 1, chest_drop_id = 403325, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 24, shape = RegionShape.SPHERE, radius = 10, pos = { x = 2670.3, y = 212.8, z = 382.1 } },
	{ config_id = 34, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2671.2, y = 212.6, z = 380.9 } }
}
