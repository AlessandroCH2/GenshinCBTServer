...
-- 怪物
monsters = {
	{ config_id = 813, monster_id = 28040101, pos = { x = 2565.9, y = 224.9, z = -1564.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 0 },
	{ config_id = 814, monster_id = 28040101, pos = { x = 2564.7, y = 224.9, z = -1568.0 }, rot = { x = 0.0, y = 1.2, z = 0.0 }, level = 0 },
	{ config_id = 815, monster_id = 28040101, pos = { x = 2569.6, y = 224.9, z = -1569.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 0 },
	{ config_id = 972, monster_id = 28040101, pos = { x = 2570.8, y = 224.9, z = -1564.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 0 }
}
