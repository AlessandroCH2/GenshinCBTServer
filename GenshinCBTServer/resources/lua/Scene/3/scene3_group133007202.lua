...
-- 装置
gadgets = {
	{ config_id = 867, gadget_id = 70210021, pos = { x = 2458.2, y = 221.4, z = 379.9 }, rot = { x = 0.0, y = 18.4, z = 0.0 }, level = 1, chest_drop_id = 403325, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT },
	{ config_id = 868, gadget_id = 70220021, pos = { x = 2457.4, y = 220.1, z = 380.4 }, rot = { x = 26.0, y = 176.5, z = 0.0 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 252, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2458.2, y = 222.4, z = 381.4 } }
}
