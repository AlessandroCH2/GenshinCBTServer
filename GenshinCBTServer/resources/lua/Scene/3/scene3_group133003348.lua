...
-- 怪物
monsters = {
	{ config_id = 1104, monster_id = 20011201, pos = { x = 2070.4, y = 224.3, z = -1585.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 5, drop_id = 303041 },
	{ config_id = 1105, monster_id = 20011201, pos = { x = 2065.5, y = 224.1, z = -1586.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 5, drop_id = 303041 }
}
