...
-- 怪物
monsters = {
	{ config_id = 797, monster_id = 20011501, pos = { x = 2055.6, y = 222.6, z = -703.5 }, rot = { x = 0.0, y = 138.2, z = 0.0 }, level = 11, drop_id = 303143, disableWander = true, affix = { 1001 }, isElite = true }
}
...
-- 装置
gadgets = {
	{ config_id = 2078, gadget_id = 70290008, pos = { x = 2071.8, y = 202.6, z = -735.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1 },
	{ config_id = 2079, gadget_id = 70500000, pos = { x = 2071.8, y = 202.6, z = -735.6 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, point_type = 3008, owner = 2078 }
}
