...
-- 装置
gadgets = {
	{ config_id = 697, gadget_id = 70220014, pos = { x = 2542.1, y = 217.0, z = -46.0 }, rot = { x = 16.0, y = 203.0, z = 0.0 }, level = 1 },
	{ config_id = 698, gadget_id = 70210101, pos = { x = 2541.8, y = 217.0, z = -46.2 }, rot = { x = 0.0, y = 310.6, z = 0.0 }, level = 1, chest_drop_id = 400101, type = GadgetType.GADGET_WORLD_CHECT }
}
