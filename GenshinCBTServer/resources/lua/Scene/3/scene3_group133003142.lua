...
-- 怪物
monsters = {
	{ config_id = 581, monster_id = 20011401, pos = { x = 2232.2, y = 235.2, z = -1357.2 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 7, drop_id = 200601, disableWander = true, affix = { 1901 }, isElite = true }
}
