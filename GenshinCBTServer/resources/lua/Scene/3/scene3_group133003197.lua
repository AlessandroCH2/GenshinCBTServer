...
-- 怪物
monsters = {
	{ config_id = 780, monster_id = 20011201, pos = { x = 2298.9, y = 211.6, z = -1079.9 }, rot = { x = 0.0, y = 206.5, z = 0.0 }, level = 3, drop_id = 303041, disableWander = true },
	{ config_id = 781, monster_id = 20011201, pos = { x = 2303.2, y = 211.5, z = -1081.6 }, rot = { x = 0.0, y = 206.5, z = 0.0 }, level = 3, drop_id = 303041, disableWander = true },
	{ config_id = 1227, monster_id = 28050101, pos = { x = 2300.9, y = 206.8, z = -1085.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 0 }
}
...
-- 装置
gadgets = {
	{ config_id = 3835, gadget_id = 70900018, pos = { x = 2302.8, y = 202.3, z = -1095.4 }, rot = { x = 334.4, y = 265.5, z = 0.0 }, level = 1 }
}
