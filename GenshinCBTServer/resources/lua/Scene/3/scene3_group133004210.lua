...
-- 怪物
monsters = {
	{ config_id = 593, monster_id = 20011401, pos = { x = 2366.8, y = 208.1, z = -465.5 }, rot = { x = 0.0, y = 28.7, z = 0.0 }, level = 12, drop_id = 303043 },
	{ config_id = 594, monster_id = 20011401, pos = { x = 2369.0, y = 207.6, z = -466.3 }, rot = { x = 0.0, y = 31.5, z = 0.0 }, level = 12, drop_id = 303043 },
	{ config_id = 595, monster_id = 20011401, pos = { x = 2367.2, y = 207.5, z = -462.8 }, rot = { x = 0.0, y = 57.7, z = 0.0 }, level = 12, drop_id = 303043 }
}
...
-- 装置
gadgets = {
	{ config_id = 1332, gadget_id = 70690001, pos = { x = 2424.5, y = 204.7, z = -442.1 }, rot = { x = 0.0, y = 72.0, z = 0.0 }, level = 1 }
}
