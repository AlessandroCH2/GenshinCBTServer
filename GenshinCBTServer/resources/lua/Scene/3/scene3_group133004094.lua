...
-- 怪物
monsters = {
	{ config_id = 253, monster_id = 20011501, pos = { x = 2238.2, y = 268.7, z = -298.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 12, drop_id = 303043 },
	{ config_id = 254, monster_id = 20011401, pos = { x = 2239.5, y = 268.7, z = -299.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 12, drop_id = 303043 },
	{ config_id = 255, monster_id = 20011401, pos = { x = 2236.6, y = 268.7, z = -298.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 12, drop_id = 303043 }
}
...
-- 装置
gadgets = {
	{ config_id = 355, gadget_id = 70210032, pos = { x = 2237.4, y = 268.7, z = -299.8 }, rot = { x = 0.0, y = 0.5, z = 0.0 }, level = 1, chest_drop_id = 403343, isOneoff = true }
}

-- 区域
regions = {
	{ config_id = 120, shape = RegionShape.SPHERE, radius = 3, pos = { x = 2237.4, y = 268.7, z = -299.3 } },
	{ config_id = 121, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2237.2, y = 268.7, z = -299.9 } }
}
