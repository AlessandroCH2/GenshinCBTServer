...
-- 怪物
monsters = {
	{ config_id = 191, monster_id = 20011201, pos = { x = 2540.7, y = 259.5, z = -1580.7 }, rot = { x = 0.0, y = 280.1, z = 0.0 }, level = 10, drop_id = 303041, ban_excel_drop = true },
	{ config_id = 192, monster_id = 20011201, pos = { x = 2547.5, y = 260.8, z = -1572.9 }, rot = { x = 0.0, y = 67.5, z = 0.0 }, level = 10, drop_id = 303041, ban_excel_drop = true },
	{ config_id = 193, monster_id = 20011201, pos = { x = 2547.4, y = 257.3, z = -1582.8 }, rot = { x = 0.0, y = 340.3, z = 0.0 }, level = 10, drop_id = 303041, ban_excel_drop = true }
}
