...
-- 装置
gadgets = {
	{ config_id = 1, gadget_id = 40000001, pos = { x = 2378.4, y = 205.2, z = -1011.5 }, rot = { x = 0.0, y = 119.7, z = 0.0 }, level = 1 }
}
...
function condition_EVENT_ENTER_REGION_8(context, evt)
	if ScriptLib.GetEntityType(evt.target_eid) == EntityType.AVATAR and ScriptLib.GetQuestState(context, evt.target_eid, 37001) == QuestState.UNFINISHED and evt.param1 == 8 then
		return true
	end
	return false
end
