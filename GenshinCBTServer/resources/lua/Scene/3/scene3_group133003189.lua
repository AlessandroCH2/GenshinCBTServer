...
-- 怪物
monsters = {
	{ config_id = 758, monster_id = 28030101, pos = { x = 2609.2, y = 223.0, z = -1258.8 }, rot = { x = 0.0, y = 112.3, z = 0.0 }, level = 0, pose_id = 2 },
	{ config_id = 759, monster_id = 28030101, pos = { x = 2608.4, y = 222.2, z = -1255.5 }, rot = { x = 0.0, y = 142.5, z = 0.0 }, level = 0, pose_id = 2 },
	{ config_id = 760, monster_id = 20011001, pos = { x = 2613.6, y = 221.2, z = -1244.5 }, rot = { x = 0.0, y = 145.8, z = 0.0 }, level = 0, drop_id = 303041 }
}
