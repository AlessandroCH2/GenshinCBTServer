...
-- 怪物
monsters = {
	{ config_id = 53, monster_id = 20011301, pos = { x = 2697.4, y = 240.1, z = 36.1 }, rot = { x = 0.0, y = 257.7, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 111, monster_id = 20011201, pos = { x = 2694.1, y = 240.1, z = 30.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 112, monster_id = 20011201, pos = { x = 2696.2, y = 240.2, z = 32.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 113, monster_id = 20010601, pos = { x = 2689.6, y = 240.1, z = 25.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 114, monster_id = 20010501, pos = { x = 2689.8, y = 239.9, z = 29.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 115, monster_id = 20010501, pos = { x = 2692.3, y = 239.9, z = 32.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 }
}
...
-- 装置
gadgets = {
	{ config_id = 429, gadget_id = 70210022, pos = { x = 2699.1, y = 240.5, z = 25.8 }, rot = { x = 0.0, y = 325.3, z = 0.0 }, level = 1, chest_drop_id = 403325, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 60, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2697.9, y = 240.4, z = 26.7 } },
	{ config_id = 61, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2697.6, y = 240.4, z = 27.9 } }
}
