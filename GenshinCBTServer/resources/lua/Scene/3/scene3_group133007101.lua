...
-- 怪物
monsters = {
	{ config_id = 159, monster_id = 20011001, pos = { x = 2144.7, y = 226.3, z = 29.0 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 160, monster_id = 20011001, pos = { x = 2148.1, y = 226.4, z = 24.9 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 }
}
...
-- 装置
gadgets = {
	{ config_id = 387, gadget_id = 70210012, pos = { x = 2149.2, y = 226.3, z = 28.5 }, rot = { x = 0.0, y = 243.4, z = 0.0 }, level = 1, chest_drop_id = 403305, isOneoff = true }
}

-- 区域
regions = {
	{ config_id = 55, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2145.8, y = 226.6, z = 29.6 } },
	{ config_id = 56, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2147.1, y = 226.6, z = 24.6 } }
}
