...
-- 怪物
monsters = {
	{ config_id = 1100, monster_id = 20010501, pos = { x = 2159.3, y = 225.4, z = -1352.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 5, drop_id = 303041 },
	{ config_id = 1101, monster_id = 20010501, pos = { x = 2159.6, y = 225.8, z = -1350.1 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 5, drop_id = 303041 }
}
