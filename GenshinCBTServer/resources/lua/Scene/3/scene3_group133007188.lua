...
-- 怪物
monsters = {
	{ config_id = 277, monster_id = 20010301, pos = { x = 2555.3, y = 214.5, z = 150.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 },
	{ config_id = 278, monster_id = 20010301, pos = { x = 2558.2, y = 214.5, z = 150.7 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 20, drop_id = 303005 }
}
...
-- 装置
gadgets = {
	{ config_id = 663, gadget_id = 70210022, pos = { x = 2556.8, y = 214.7, z = 152.9 }, rot = { x = 0.0, y = 171.7, z = 0.0 }, level = 1, chest_drop_id = 403325, isOneoff = true, persistent = true }
}

-- 区域
regions = {
	{ config_id = 214, shape = RegionShape.SPHERE, radius = 6, pos = { x = 2556.8, y = 214.5, z = 151.7 } },
	{ config_id = 215, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2556.4, y = 214.5, z = 152.6 } }
}
