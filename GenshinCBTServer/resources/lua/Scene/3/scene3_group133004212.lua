...
-- 怪物
monsters = {
	{ config_id = 548, monster_id = 20011501, pos = { x = 2493.7, y = 253.7, z = -334.6 }, rot = { x = 0.0, y = 101.2, z = 0.0 }, level = 12, drop_id = 303043 },
	{ config_id = 549, monster_id = 20011401, pos = { x = 2492.5, y = 254.0, z = -332.6 }, rot = { x = 0.0, y = 98.5, z = 0.0 }, level = 12, drop_id = 303043 },
	{ config_id = 550, monster_id = 20011401, pos = { x = 2491.5, y = 254.1, z = -336.0 }, rot = { x = 0.0, y = 80.9, z = 0.0 }, level = 12, drop_id = 303043 }
}
...
-- 装置
gadgets = {
	{ config_id = 1186, gadget_id = 70210032, pos = { x = 2492.1, y = 254.0, z = -334.2 }, rot = { x = 8.3, y = 108.1, z = 1.9 }, level = 1, chest_drop_id = 403343, isOneoff = true, persistent = true, type = GadgetType.GADGET_WORLD_CHECT }
}

-- 区域
regions = {
	{ config_id = 227, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2492.1, y = 254.0, z = -334.0 } },
	{ config_id = 228, shape = RegionShape.SPHERE, radius = 5, pos = { x = 2492.9, y = 253.9, z = -333.7 } }
}
