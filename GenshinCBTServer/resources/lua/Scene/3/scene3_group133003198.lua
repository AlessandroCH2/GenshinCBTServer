...
-- 怪物
monsters = {
	{ config_id = 782, monster_id = 28020201, pos = { x = 2216.4, y = 207.2, z = -1111.5 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 0 },
	{ config_id = 807, monster_id = 20011201, pos = { x = 2212.7, y = 212.7, z = -1115.2 }, rot = { x = 0.0, y = 36.8, z = 0.0 }, level = 5, drop_id = 303041, disableWander = true },
	{ config_id = 808, monster_id = 20011201, pos = { x = 2214.3, y = 209.1, z = -1108.9 }, rot = { x = 0.0, y = 92.6, z = 0.0 }, level = 5, drop_id = 303041, disableWander = true }
}
