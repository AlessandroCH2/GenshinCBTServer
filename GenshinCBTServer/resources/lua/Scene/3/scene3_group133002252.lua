...
-- 怪物
monsters = {
	{ config_id = 828, monster_id = 20010301, pos = { x = 1967.1, y = 238.3, z = -386.0 }, rot = { x = 0.0, y = 197.8, z = 0.0 }, level = 7, drop_id = 303042 },
	{ config_id = 829, monster_id = 20010301, pos = { x = 1970.4, y = 237.8, z = -386.9 }, rot = { x = 0.0, y = 228.5, z = 0.0 }, level = 7, drop_id = 303042 }
}
