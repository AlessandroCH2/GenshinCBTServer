...
gadgets = {
	...
	{ config_id = 11, gadget_id = 70210011, pos = { x = 353.3, y = -23.7, z = 385.3 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, chest_drop_id = 1400401, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 12, gadget_id = 70210011, pos = { x = 343.1, y = -23.7, z = 385.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, chest_drop_id = 1400401, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 13, gadget_id = 70210011, pos = { x = 333.2, y = -23.7, z = 385.4 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, chest_drop_id = 1400401, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	...
	{ config_id = 118, gadget_id = 70210021, pos = { x = 353.2, y = -16.9, z = 308.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, chest_drop_id = 1400402, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 119, gadget_id = 70210021, pos = { x = 343.2, y = -16.9, z = 308.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, chest_drop_id = 1400402, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
	{ config_id = 120, gadget_id = 70210021, pos = { x = 333.3, y = -16.9, z = 308.8 }, rot = { x = 0.0, y = 0.0, z = 0.0 }, level = 1, chest_drop_id = 1400402, type = GadgetType.GADGET_DUNGEON_SECRET_CHEST },
...
regions = {
	...
	{ config_id = 56, shape = RegionShape.SPHERE, radius = 5, pos = { x = 343.3, y = -28.0, z = 412.6 } },
	...
	{ config_id = 70, shape = RegionShape.SPHERE, radius = 5, pos = { x = 343.0, y = -28.0, z = 396.7 } },
	{ config_id = 71, shape = RegionShape.SPHERE, radius = 5, pos = { x = 353.5, y = -28.0, z = 395.4 } },
	{ config_id = 72, shape = RegionShape.SPHERE, radius = 5, pos = { x = 333.0, y = -28.0, z = 397.5 } },
	{ config_id = 73, shape = RegionShape.SPHERE, radius = 5, pos = { x = 352.5, y = -18.0, z = 311.8 } },
	{ config_id = 74, shape = RegionShape.SPHERE, radius = 5, pos = { x = 342.8, y = -18.4, z = 313.9 } },
	{ config_id = 75, shape = RegionShape.SPHERE, radius = 5, pos = { x = 332.2, y = -18.4, z = 314.9 } }
}
...
triggers = {
	...
	{ name = "CLIENT_EXECUTE_56", event = EventType.EVENT_CLIENT_EXECUTE, source = "FireSourceChange", condition = "", action = "action_EVENT_CLIENT_EXECUTE_56", trigger_count = 0 },
...
-- 变量
variables = {
	{ name = "Enter_FireChoice", value = 0, persistent = false },
	{ name = "Enter_IceChoice", value = 0, persistent = false },
	{ name = "Enter_ElecChoice", value = 0, persistent = false }
}
...
suites = {
	{
		...
		regions = { 3, 4, 5, 25, 26, 27, 28, 38, 52, 56, 57, 61, 67, 68, 69, 70, 71, 72, 73, 74, 75 },
		triggers = { "ENTER_REGION_3", "ENTER_REGION_4", "ENTER_REGION_5", "ENTER_REGION_25", "ENTER_REGION_26", "ENTER_REGION_27", "ENTER_REGION_28", "ENTER_REGION_38", "ENTER_REGION_52", "CLIENT_EXECUTE_56", "ENTER_REGION_57", "ENTER_REGION_61", "ENTER_REGION_67", "ENTER_REGION_68", "ENTER_REGION_69", "TIMER_EVENT_70", "TIMER_EVENT_71", "TIMER_EVENT_72", "TIMER_EVENT_73", "TIMER_EVENT_74", "TIMER_EVENT_75" },
		rand_weight = 100
	}
}
...
function action_EVENT_ENTER_REGION_3(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220013001, 3, GadgetState.Default) then
			return -1
		end 
	
	-- 改变指定group组220013001中， configid为2的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220013001, 2, GadgetState.Default) then
			return -1
		end 
	
	-- 改变指定group组220013001中， configid为1的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220013001, 1, GadgetState.Default) then
			return -1
		end 
...
function action_EVENT_ENTER_REGION_25(context, evt)
	...
	if 0 ~= ScriptLib.ShowReminder(context, 10051401) then
		...
		if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220013003, 14, GadgetState.Default) then
				return -1
			end 
		
		-- 改变指定group组220013003中， configid为15的gadget的state
		if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220013003, 15, GadgetState.Default) then
				return -1
			end 
		
		-- 改变指定group组220013003中， configid为16的gadget的state
		if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220013003, 16, GadgetState.Default) then
				return -1
			end 
		
		-- 根据不同的选项做不同的操作
		if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 115, GadgetState.GearStart) then
				return -1
			end 
...
function action_EVENT_ENTER_REGION_26(context, evt)
	...
	if 0 ~= ScriptLib.ShowReminder(context, 10051501) then
		...
		if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 116, GadgetState.GearStart) then
				return -1
			end 
...
function action_EVENT_ENTER_REGION_27(context, evt)
	...
	if 0 ~= ScriptLib.ShowReminder(context, 10051601) then
		...
		-- 根据不同的选项做不同的操作
		if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 117, GadgetState.GearStart) then
				return -1
			end 
...
-- 触发操作
function action_EVENT_CLIENT_EXECUTE_56(context, evt)
	-- 针对groupid为 220013002 中该config对应的物件进行状态改变操作
	local this_gadget = ScriptLib.GetGadgetConfigId(context, { gadget_eid = evt.source_eid })
		--ScriptLib.PrintLog("config_id="..this_gadget)
	
		if evt.param1 == 1 then
			ScriptLib.SetGroupGadgetStateByConfigId(context, 220013002, this_gadget, GadgetState.GearStart )
			return 0
		end
	
		if evt.param1 == 0 then
			ScriptLib.SetGroupGadgetStateByConfigId(context, 220013002, this_gadget, GadgetState.Default )
			return 0
		end
...
function action_EVENT_ENTER_REGION_57(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 231, GadgetState.GearStart) then
			return -1
		end 
...
function action_EVENT_TIMER_EVENT_70(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 233, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 234, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 235, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 236, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 237, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 238, GadgetState.GearStart) then
...
function action_EVENT_TIMER_EVENT_71(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 223, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 224, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 225, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 226, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 229, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 230, GadgetState.GearStart) then
...
function action_EVENT_TIMER_EVENT_72(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 242, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 243, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 244, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 245, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 246, GadgetState.GearStart) then
...
function action_EVENT_TIMER_EVENT_73(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 254, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 255, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 256, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 257, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 258, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 259, GadgetState.GearStart) then
...
function action_EVENT_TIMER_EVENT_74(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 262, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 263, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 264, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 265, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 266, GadgetState.GearStart) then
...
function action_EVENT_TIMER_EVENT_75(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 270, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 271, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 272, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 273, GadgetState.GearStart) then
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 274, GadgetState.GearStart) then
	
			return -1
		end 
	
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 275, GadgetState.GearStart) then
