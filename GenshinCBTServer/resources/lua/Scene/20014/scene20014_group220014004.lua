...
-- 怪物
monsters = {
	{ config_id = 29, monster_id = 20010501, pos = { x = 212.9, y = 57.0, z = 343.3 }, rot = { x = 0.0, y = 182.6, z = 0.0 }, level = 0, disableWander = true },
	{ config_id = 30, monster_id = 20010501, pos = { x = 217.0, y = 57.0, z = 343.4 }, rot = { x = 0.0, y = 182.6, z = 0.0 }, level = 0, disableWander = true },
	{ config_id = 35, monster_id = 20010501, pos = { x = 214.6, y = 57.0, z = 343.4 }, rot = { x = 0.0, y = 195.9, z = 0.0 }, level = 0 }
}
...
regions = {
	...
	{ config_id = 39, shape = RegionShape.SPHERE, radius = 5, pos = { x = 215.8, y = 57.0, z = 338.2 } }
}
...
function action_EVENT_ANY_MONSTER_DIE_39(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220014002, 36, GadgetState.Default) then
			return -1
		end 
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 220014002, 36, {8}) then
		return -1
	end
	
	-- 改变指定group组27中， configid为220014002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 27, 220014002, GadgetState.GearStart) then
			return -1
		end 
